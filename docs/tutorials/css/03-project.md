...
- **教程与参考**：[MDN Flexbox](https://developer.mozilla.org/zh-CN/docs/Web/CSS/CSS_flexible_box_layout) · [MDN Grid](https://developer.mozilla.org/zh-CN/docs/Web/CSS/CSS_grid_layout) · [MDN CSS 动画](https://developer.mozilla.org/zh-CN/docs/Web/CSS/CSS_animations)
- **布局**：[CSS Grid 规范](https://drafts.csswg.org/css-grid/)
- **响应式与深色模式**：[MDN 媒体查询](https://developer.mozilla.org/zh-CN/docs/Web/CSS/CSS_media_queries/Using_media_queries) · [MDN `prefers-color-scheme`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/@media/prefers-color-scheme)
