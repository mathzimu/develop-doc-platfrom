...
标准库签名、内存模型、模块解析规则以下列一手文档为准。

| 类型 | 链接 |
|------|------|
| 官方文档 | [go.dev/doc](https://go.dev/doc/) · [新手教程](https://go.dev/doc/tutorial/getting-started) |
| 语言规范 | [Go Spec](https://go.dev/ref/spec) |
| 标准库 | [pkg.go.dev/std](https://pkg.go.dev/std) |
| 模块机制 | [Go Modules Reference](https://go.dev/ref/mod) |
| 命令与工具 | [go 命令文档](https://pkg.go.dev/cmd/go) · [go vet](https://pkg.go.dev/cmd/vet) |
