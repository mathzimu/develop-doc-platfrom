...
- **构建工具**：[Vite](https://vite.dev/guide/) · [Rollup](https://rollupjs.org/) · [esbuild](https://esbuild.github.io/)
- **包与注册表**：[npm Docs](https://docs.npmjs.com/) · [pnpm](https://pnpm.io/zh/motivation)
